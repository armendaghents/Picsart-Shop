...
// Reading them back off a request, the counterpart to serializeCookie below.
...
// Whether to set the Secure attribute. Checked per request rather than from a
// setting so the same build works on plain http://localhost in development and
// over TLS in production, including behind a proxy that terminates it.
